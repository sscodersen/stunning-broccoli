      ...
      {!isIOS && (
        <>
          ...
          <Collapse.Group>
            ...
            <Collapse
              title={
                <Text h4 className="nectargpt--mt-5 nectargpt--mb-0">
                  YouTube / Bilibili{' '}
                </Text>
              }
            >
              ...
              <Text className="nectargpt--my-1">Example Prompts: </Text>
              <ul className="nectargpt--prompt__list">
                <li>
            ...
            <Collapse
              title={
                <Text h4 className="nectargpt--mt-5 nectargpt--mb-0">
                  Comment Summary{' '}
                  <Text span font="12px" className="nectargpt--subtitle">
