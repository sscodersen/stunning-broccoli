...
import EnableNectargpt from './components/EnableNectargpt'
...
function OptionsPage(
  ...
  return (
    <div className="nectargpt--container nectargpt--mx-auto">
      <Header />

      <main className="nectargpt--w-[900px] nectargpt--mx-auto nectargpt--mt-14 nectargpt--options">
        ...
        {/* Language */}
        <Text h3 className="nectargpt--mt-5 nectargpt--mb-0">
          Language
        </Text>
        <Text className="nectargpt--my-1">
          The language used in ChatGPT response. <span className="nectargpt--italic">Auto</span> is
          recommended.
        </Text>
        <Select
          value={language}
        ...
        {/* Misc */}
        {/* <Text h3 className="nectargpt--mt-8">
          Misc
        </Text>
        <div className="nectargpt--flex nectargpt--flex-row nectargpt--items-center nectargpt--gap-4">
